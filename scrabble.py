...
class Rack:
    ...
    def get_rack_str(self):
        #Displays the user's hand in string form.
...
class Board:
    ...
    def add_premium_squares(self):
        #Adds all of the score multipliers
...
class Word:
    ...
    def check_word(self):
        ...
        if self.word != "":
            ...
            #Ensures that the words overlap correctly
            for i in range(len(self.word)):
            ...
            #If there is a blank tile, remove it's value from the tiles
            if blank_tile_val != "":
